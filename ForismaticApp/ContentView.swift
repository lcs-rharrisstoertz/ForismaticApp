...
struct ContentView: View {
    ...
    func fetchQuote() {
        ...
        URLSession.shared.dataTask(with: request) { data, response, error in
            ...
            // Attempt to decode the JSON into an instance of the forismaticQuote structure
            if let decodedQuoteData = try? JSONDecoder().decode(forismaticQuote.self, from: quoteData) {
                ...
                print("Could not decode JSON into an instance of the forismaticQuote structure.")
